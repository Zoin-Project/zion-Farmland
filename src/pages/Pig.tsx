...
import Fish1 from "../assets/images/pig.jpg";
import Fish2 from "../assets/images/black-pig.jpg";
import Fish3 from "../assets/images/pigs-raised-farm.jpg";
import Fish4 from "../assets/images/pig.jpg";
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <section className="">
          <h1 className="text-4xl font-bold text-green-800 mb-8">Pig Details</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            {/* Content */}
            <div>
              <h2 className="text-3xl font-semibold mb-4">Fresh Farm Fish</h2>
